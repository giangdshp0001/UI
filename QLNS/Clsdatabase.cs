...
namespace QLNS
{
    class Clsdatabase
    {
        string strconnect = "Data Source=DESKTOP-UT28GA1;Initial Catalog=QLNS;Persist Security Info=True;User ID=sa;Password=123456789";
        ...
        public void loaddatagridview2(DataGridView dg, string strselect)
        {
            ds.Clear();
            sqlda = new SqlDataAdapter(strselect, strconnect);
