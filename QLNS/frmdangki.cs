    ...
    public partial class frmdangki : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dateTimePicker1.CustomFormat = "MM/dd/yyyy";
                ...
                {
                   insert = "insert into tbuser values(N'" + textBox1.Text + "',N'" + textBox2.Text + "',N'User',N'" + textBox3.Text + "','" + dateTimePicker1.Text + "')";
                //Username	Pass	Quyen	Ten	Ngaysinh

                        }
                else
                 insert = "insert into tbuser values(N'" + textBox1.Text + "',N'" + textBox2.Text + "',N'" + textBox4.Text + "',N'" + textBox3.Text + "','" + dateTimePicker1.Text + "')";
        ...
        private void frmdangki_Load(object sender, EventArgs e)
        {
            ...
            if (Global.testquyen == "xxx")
            {
                ...
                blbTieude.Text = "ĐĂNG KÝ DÙNG THỬ";
                button6.Enabled = false;
                button1.Enabled = false;
           }
            else
            {
                lblquyen.Visible = true;
                textBox4.Visible = true;
                blbTieude.Text = "PHÂN QUYỀN NGƯỜI DÙNG";
        ...
        private void frmdangki_Activated(object sender, EventArgs e)
        {
         
        }

        private void frmdangki_Shown(object sender, EventArgs e)
        {
           
                      if (Global.testquyen == "QuanTriVien")
